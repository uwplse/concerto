...
public class TestAIContinuation extends AbstractInterpretationTest {
	public TestAIContinuation() {
		super(Continuation.class.getName(), "main", new NullReflectionModel());
	}

	@Test
	public void testAIContination() {
